                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                            ...
                            <form class="form-horizontal" role="form" method="POST" action="{{ route('qudao.update', $qudao->id) }}">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="qdname" autofocus id="title" value="{{ $qudao->qdname }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <select name="quyu_id"  class="form-control" multiple>
                                                @foreach ($quyus as $quyu)
                                                    <option @if ($quyu->id===$qudao->quyu_id) selected @endif value="{{ $quyu->id }}">
                                                        {{ $quyu->qyname }}
                                                    </option>
                                                @endforeach
                                            </select>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form method="POST" action="{{ route('qudao.destroy', $qudao->id) }}">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
