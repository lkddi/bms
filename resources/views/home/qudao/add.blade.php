        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">渠道管理 <small>» 新增</small></div>
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                            ...
                            <form class="form-horizontal" role="form" method="POST" action="{{ route('qudao.store') }}">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="qdname" autofocus id="title" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
